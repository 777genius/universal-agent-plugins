...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	// Public entry points distinguish available installation from unreleased authoring.
	mustContain(t, string(rootReadme), "## Use plugins")
	mustContain(t, string(rootReadme), "npx universal-agent-plugins add context7")
	mustContain(t, string(rootReadme), "## Build plugins")
	mustContain(t, strings.ReplaceAll(string(rootReadme), "\r\n", "\n"), "Build portable Agent Plugins 1.0 packages around `plugin.json`, with optional\n`skills/` and `mcp.json`.")
	mustContain(t, string(rootReadme), "**Preparation — unreleased:** the standard-first authoring CLI is not released.")
	mustContain(t, string(rootReadme), "`plugin-kit-ai@latest` is the historical v1 tool, not standard-first v2.")
	...
	mustContain(t, string(rootReadme), "The reference below is for historical v1 maintenance.")
	...
	mustContain(t, string(rootReadme), "`plugin-kit-ai` keeps authored source under `plugin/`, generates the supported outputs you need, and helps you validate the repo before handoff.")
	mustContain(t, string(rootReadme), "supported outputs for Claude, Codex, Gemini, Cursor, and OpenCode where the repo shape allows it")
	mustContain(t, string(rootReadme), "The honest promise is `one repo / many supported outputs`, not fake parity everywhere")
	mustContain(t, string(rootReadme), "overview: [plugin-kit-ai documentation](https://777genius.github.io/universal-agent-plugins/docs/en/)")
	mustContain(t, string(rootReadme), "Use / Build and historical v1 maintenance: [Quickstart](https://777genius.github.io/universal-agent-plugins/docs/en/guide/quickstart.html)")
	mustContain(t, string(rootReadme), "historical v1 template selection: [Choose What You Are Building](https://777genius.github.io/universal-agent-plugins/docs/en/guide/choose-what-you-are-building.html)")
	mustContain(t, string(rootReadme), "one repo, many outputs: [What You Can Build](https://777genius.github.io/universal-agent-plugins/docs/en/guide/what-you-can-build.html)")
	mustContain(t, string(rootReadme), "honest caveat: [Support Boundary](https://777genius.github.io/universal-agent-plugins/docs/en/reference/support-boundary.html)")
	mustContain(t, string(rootReadme), "## Choose What You Are Building")
	mustContain(t, string(rootReadme), "### Connect an online service")
	mustContain(t, string(rootReadme), "### Connect a local tool")
	mustContain(t, string(rootReadme), "### Build custom plugin logic")
	...
	mustContain(t, string(rootReadme), "plugin-kit-ai init my-plugin --template online-service")
	mustContain(t, string(rootReadme), "plugin-kit-ai init my-plugin --template local-tool")
	mustContain(t, string(rootReadme), "plugin-kit-ai init my-plugin --template custom-logic")
	mustContain(t, string(rootReadme), "plugin-kit-ai init my-plugin")
	mustContain(t, string(rootReadme), "plugin-kit-ai generate .")
	mustContain(t, string(rootReadme), "plugin-kit-ai validate . --platform codex-runtime --strict")
	mustContain(t, string(rootReadme), "## Works Across Multiple Outputs")
	mustContain(t, string(rootReadme), "## What To Do Next")
	mustContain(t, string(rootReadme), "## Keep This Rule In Mind")
	...
	mustContain(t, string(rootReadme), "## Go Deeper By Goal")
	...
	mustContain(t, string(rootReadme), "`generate`, `import`, and `normalize` are still `public-beta`")
	...
	mustContain(t, string(rootReadme), "## SDK And CLI")
	mustContain(t, string(rootReadme), "Go SDK packages:")
	mustContain(t, string(rootReadme), "`github.com/777genius/plugin-kit-ai/sdk/claude`")
	mustContain(t, string(rootReadme), "`github.com/777genius/plugin-kit-ai/sdk/codex`")
	mustContain(t, string(rootReadme), "`github.com/777genius/plugin-kit-ai/sdk/gemini`")
	...
	mustContain(t, string(rootReadme), "`plugin-kit-ai validate --format json` now emits the versioned `plugin-kit-ai/validate-report` contract")
	mustContain(t, string(rootReadme), "[docs/CODEX_TARGET_BOUNDARY.md](docs/CODEX_TARGET_BOUNDARY.md)")
	mustContain(t, string(rootReadme), "[docs/VALIDATE_JSON_CONTRACT.md](docs/VALIDATE_JSON_CONTRACT.md)")
