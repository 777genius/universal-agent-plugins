...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	mustContain(t, currentProse, "npm install -g universal-agent-plugins@0.1.62")
	mustContain(t, currentProse, "npm install -g plugin-kit-ai@2.0.2")
	mustContain(t, currentProse, "agentplugins-v0.1.62")
	mustContain(t, currentProse, "plugin-kit-ai-v2.0.2")
	...
	mustContain(t, historicalReadme, "### Legacy quick start")
	...
	mustContain(t, historicalReadme, "### Support and references")
