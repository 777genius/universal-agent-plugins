...
test-agentplugins-resilience:
	python3 scripts/run-agentplugins-resilience-e2e.py
...
test-required:
	...
	$(MAKE) test-agentplugins-js

test-agentplugins-js:
	cd npm/quality && npm ci --ignore-scripts --no-audit --no-fund
	node npm/quality/check-quality-scope.js
	node --test npm/quality/check-quality-scope.test.js
	npm --prefix npm/quality exec -- oxlint --config npm/agentplugins/oxlint.json --deny-warnings --disable-nested-config npm/agentplugins/bin npm/agentplugins/lib npm/agentplugins/scripts npm/plugin-kit-ai/bin npm/plugin-kit-ai/lib npm/plugin-kit-ai-runtime/index.js examples/local/codex-node-local/plugin/main.mjs examples/local/codex-node-local/plugin/plugin-runtime.mjs examples/local/codex-node-typescript-local/plugin/main.ts examples/local/codex-node-typescript-local/plugin/plugin-runtime.ts examples/plugins/opencode-basic/.opencode/plugins/custom-tool.js examples/plugins/opencode-basic/.opencode/plugins/example.js examples/plugins/opencode-basic/.opencode/tools/echo.ts examples/plugins/opencode-basic/plugin/targets/opencode/plugins/custom-tool.js examples/plugins/opencode-basic/plugin/targets/opencode/plugins/example.js examples/plugins/opencode-basic/plugin/targets/opencode/tools/echo.ts examples/starters/claude-node-typescript-runtime-package-starter/plugin/main.ts examples/starters/claude-node-typescript-starter/plugin/main.ts examples/starters/claude-node-typescript-starter/plugin/plugin-runtime.ts examples/starters/codex-node-typescript-starter/plugin/main.ts examples/starters/codex-node-typescript-starter/plugin/plugin-runtime.ts npm/quality/check-quality-scope.js scripts/terminal-ui/stage_npm.js
	npm --prefix npm/quality exec -- oxlint --config npm/agentplugins/oxlint.json --deny-warnings --disable-nested-config -D correctness npm/agentplugins/bin npm/agentplugins/lib npm/plugin-kit-ai/bin npm/plugin-kit-ai/lib npm/plugin-kit-ai-runtime/index.js examples/local/codex-node-local/plugin/main.mjs examples/local/codex-node-local/plugin/plugin-runtime.mjs examples/local/codex-node-typescript-local/plugin/main.ts examples/local/codex-node-typescript-local/plugin/plugin-runtime.ts examples/plugins/opencode-basic/.opencode/plugins/custom-tool.js examples/plugins/opencode-basic/.opencode/plugins/example.js examples/plugins/opencode-basic/.opencode/tools/echo.ts examples/plugins/opencode-basic/plugin/targets/opencode/plugins/custom-tool.js examples/plugins/opencode-basic/plugin/targets/opencode/plugins/example.js examples/plugins/opencode-basic/plugin/targets/opencode/tools/echo.ts examples/starters/claude-node-typescript-runtime-package-starter/plugin/main.ts examples/starters/claude-node-typescript-starter/plugin/main.ts examples/starters/claude-node-typescript-starter/plugin/plugin-runtime.ts examples/starters/codex-node-typescript-starter/plugin/main.ts examples/starters/codex-node-typescript-starter/plugin/plugin-runtime.ts
	npm --prefix npm/quality exec -- tsc -p npm/plugin-kit-ai-runtime/tsconfig.docs.json --noEmit
...
test-govulncheck-local:
	...
	cd plugininstall && GOTOOLCHAIN=$(SECURITY_GOTOOLCHAIN) go run golang.org/x/vuln/cmd/govulncheck@v1.6.0 ./...
