...
func checkFactsBoundary(repo string) error {
	modules := map[string]string{repositoryModule + "/cli": "cli", repositoryModule + "/install/integrationctl/agentplugins": "install/integrationctl/agentplugins", repositoryModule + "/install/integrationctl": "install/integrationctl", repositoryModule + "/plugininstall": "plugininstall", repositoryModule + "/sdk": "sdk", repositoryModule: "."}
