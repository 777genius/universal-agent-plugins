...
const TAG = "agentplugins-v0.1.65";
const KIT_TAG = "plugin-kit-ai-v2.0.5";
const GH = "/usr/bin/gh";
...
function recordShape(value) {
  ...
  exact(identity, { repository: REPOSITORY, commit: identity.commit, engine_revision: identity.commit,
    versions: { agentplugins: "0.1.65", "plugin-kit-ai": "2.0.5" } }, "Milestone A record identity");
  ...
  for (const product of c.PRODUCTS) {
    ...
    exact(source.tag, product === "agentplugins" ? "agentplugins-v0.1.65" : "plugin-kit-ai-v2.0.5", "Milestone A product tag");
...
function receiptContract(prepare, runs, source) {
  ...
  return { source, engine_revision: source, test_versions: E2E_VERSIONS,
    release_versions: { agentplugins: "0.1.65", "plugin-kit-ai": "2.0.5" } };
}
...
function evidenceContract(run, jobs, selected, pin) {
  ...
  exact(selected, { tag: TAG, ref: `refs/tags/${TAG}`, source: selected.source,
    versions: { agentplugins: "0.1.65", "plugin-kit-ai": "2.0.5" } }, "fixed paired release selection");
