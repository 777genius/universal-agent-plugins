...
for (const claim of ["Use plugins", "Build plugins", "Milestone A release candidate", "Availability is unverified", "0.1.62", "2.0.2", "Historical v1 maintenance", "plugin.json"]) {
