---
title: "安装频道"
description: "plugin-kit-ai 的公共安装渠道。"
...
|频道|使用时 |笔记|
| --- | --- | --- |
| Homebrew |您想要默认用户设置 |推荐首选|
| npm 包 |您的环境已经以 npm 为中心 |安装已发布的二进制文件 |
| PyPI 包 |您的环境已经以 Python 为中心 |安装已发布的二进制文件 |
|已验证的脚本 |您需要一个后备安装方法 |有用的外部包管理器优先设置 |
