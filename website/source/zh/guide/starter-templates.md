---
title: "入门模板"
description: "plugin-kit-ai 中常见第一路径的官方入门存储库。"
...
<p class="locale-historical-identity">入门模板</p>
...
如果您想要更广泛的系统视图，请阅读[一个项目，多个目标](/zh/guide/one-project-multiple-targets)。
