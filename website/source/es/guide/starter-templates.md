...
description: "Repositorios de inicio oficiales para las primeras rutas comunes en plugin-kit-ai."
...
Eso **no** significa que el repositorio esté permanentemente bloqueado para una familia de agentes.

Un iniciador te ayuda a elegir la mejor primera forma para:

- su requisito principal de tiempo de ejecución
- elección de idioma de tu equipo
- tu primer objetivo apoyado

Después de eso, mantenga el repositorio unificado y hágalo crecer según sea necesario.
...
- quieres incorporar compañeros de equipo con menos conjeturas

Utilice `plugin-kit-ai init` directamente cuando:

- quieres un repositorio nuevo desde los primeros principios
- necesitas elegir banderas explícitamente
- estás construyendo alrededor de una estructura de repositorio existente
