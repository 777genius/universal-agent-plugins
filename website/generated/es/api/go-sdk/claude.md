---
title: "claude"
description: "Referencia generada del paquete Go SDK for github.com/777genius/plugin-kit-ai/sdk/claude"
...
**Ruta de importación:** `github.com/777genius/plugin-kit-ai/sdk/claude`

```go
import "github.com/777genius/plugin-kit-ai/sdk/claude"
```

Package claude exposes typed public hook inputs, responses, and registrars for Claude plugin runtime integrations.
