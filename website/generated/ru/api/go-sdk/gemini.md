---
title: "gemini"
description: "Generated Go SDK package reference for github.com/777genius/plugin-kit-ai/sdk/gemini"
...
**Путь импорта:** `github.com/777genius/plugin-kit-ai/sdk/gemini`

```go
import "github.com/777genius/plugin-kit-ai/sdk/gemini"
```

Пакет `gemini` публикует типизированные входные Gemini hooks, ответы и регистраторы для production-ready Go runtime-пути Gemini, включая текущую стабильную 9-hook surface.
