...
description: "生成的 Python runtime 参考"
...
- If you want the simplest end-to-end setup, start with [Build A Python Runtime Plugin](/zh/guide/python-runtime).
- If you are still choosing the project shape, read [What You Can Build](/zh/guide/what-you-can-build) and [Choosing Runtime](/zh/concepts/choosing-runtime).
...
- [`plugin_kit_ai_runtime`](/zh/api/runtime-python/plugin-kit-ai-runtime)
