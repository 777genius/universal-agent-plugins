---
title: "agentplugins author skills"
description: "Create and validate standard package Skills"
canonicalId: "prepared-authoring-v2:agentplugins author skills"
section: "api"
...
# agentplugins author skills

Create and validate standard package Skills
...
```
agentplugins author skills [flags]
```
...
```
      ...
      --color auto|never|always   human output color: auto, never, always (default auto)
...
* [agentplugins author skills init](/en/api/cli/prepared-authoring-v2-agentplugins-author-skills-init)	 - Atomically add one Skill to an absent skills/&lt;name&gt; destination
* [agentplugins author skills validate](/en/api/cli/prepared-authoring-v2-agentplugins-author-skills-validate)	 - Validate immediate Skills and package readiness using the embedded profile; no execution
