...
description: "Atomically add one Skill to an absent skills/<name> destination"
canonicalId: "prepared-authoring-v2:plugin-kit-ai skills init"
section: "api"
...
```
plugin-kit-ai skills init <name> [package-path] [flags]
```
