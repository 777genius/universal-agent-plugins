---
title: "agentplugins author skills validate"
description: "Validate immediate Skills and package readiness using the embedded profile; no execution"
canonicalId: "prepared-authoring-v2:agentplugins author skills validate"
section: "api"
...
```
agentplugins author skills validate [package-path] [flags]
```
