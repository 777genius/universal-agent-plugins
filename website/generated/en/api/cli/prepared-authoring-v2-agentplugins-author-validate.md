---
title: "agentplugins author validate"
description: "Validate exact-root standard configuration and authoring readiness"
canonicalId: "prepared-authoring-v2:agentplugins author validate"
section: "api"
...
Validate exact-root standard configuration and authoring readiness
...
```
agentplugins author validate [package-path] [flags]
```
