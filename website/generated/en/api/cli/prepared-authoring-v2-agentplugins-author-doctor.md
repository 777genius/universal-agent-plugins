---
title: "agentplugins author doctor"
description: "Inspect captured native files and executable metadata; no processes or network"
canonicalId: "prepared-authoring-v2:agentplugins author doctor"
section: "api"
...
# agentplugins author doctor

Inspect captured native files and executable metadata; no processes or network
...
```
agentplugins author doctor [package-path] [flags]
```
