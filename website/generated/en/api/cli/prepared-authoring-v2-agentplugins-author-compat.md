---
title: "agentplugins author compat"
description: "Evaluate explicit --target clients using static adapter support; no installed clients required"
canonicalId: "prepared-authoring-v2:agentplugins author compat"
section: "api"
...
# agentplugins author compat

Evaluate explicit --target clients using static adapter support; no installed clients required
...
```
agentplugins author compat [package-path] [flags]
```
