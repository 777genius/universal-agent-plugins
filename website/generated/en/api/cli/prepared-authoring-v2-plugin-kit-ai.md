---
title: "plugin-kit-ai"
description: "Build Agent Plugins packages"
canonicalId: "prepared-authoring-v2:plugin-kit-ai"
section: "api"
...
* [plugin-kit-ai capabilities](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-capabilities)	 - Show embedded schemas, profiles, live client metadata and implemented commands
* [plugin-kit-ai compat](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-compat)	 - Evaluate explicit --target clients using static adapter support; no installed clients required
* [plugin-kit-ai completion](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-completion)	 - Generate the autocompletion script for the specified shell
* [plugin-kit-ai doctor](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-doctor)	 - Inspect captured native files and executable metadata; no processes or network
* [plugin-kit-ai init](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-init)	 - Create an offline standard package in an absent destination
* [plugin-kit-ai inspect](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-inspect)	 - Inspect captured components and unresolved runtime requirements
* [plugin-kit-ai skills](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-skills)	 - Create and validate standard package Skills
* [plugin-kit-ai test](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-test)	 - Check configuration, hygiene, Skills and MCP statically; runtime is not evaluated
* [plugin-kit-ai validate](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-validate)	 - Validate exact-root standard configuration and authoring readiness
* [plugin-kit-ai version](/en/api/cli/prepared-authoring-v2-plugin-kit-ai-version)	 - Print product version and shared authoring engine revision
